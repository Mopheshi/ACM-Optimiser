...
import torch
import pytest
from acm.optimiser import ACM, set_seed
...
def test_reproducibility():
    ...
    assert torch.allclose(result_one, result_two), "Deterministic seeding failed to produce identical gradient trajectories."
